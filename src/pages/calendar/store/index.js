...
export const fetchEvents = createAsyncThunk('appCalendar/fetchEvents', async calendars => {
  const response = await axios.get('/calendar/events', { calendars })
  console.log(response)
  return response.data
})

export const addEvent = createAsyncThunk('appCalendar/addEvent', async (event, { dispatch, getState }) => {
  await axios.post('/calendar/add-event', { event })
...
export const updateEvent = createAsyncThunk('appCalendar/updateEvent', async (event, { dispatch, getState }) => {
  await axios.post('/calendar/update-event', { event })
  await dispatch(fetchEvents(getState().calendar.selectedCalendars))
  return event
})
...
export const removeEvent = createAsyncThunk('appCalendar/removeEvent', async id => {
  await axios.delete('/calendar/remove-event', { id })
  return id
})
...
// export const { selectEvent, fetchEvents, updateFilter, updateAllFilters, addEvent, removeEvent, updateEvent } = appCalendarSlice.actions
